...
| TL082 JFET-input dual op-amp, DIP-8 | 10 | Received 2026-09-12 (ordered 2026-09-03); untested. 2 of 10 used (1 each) in `lab/signal_conditioning/electric_field_probe/` (tier5 `EPFIELD`) and `lab/signal_conditioning/charge_amplifier/` (tier5 `CHGAMP`), both designed/simulated 2026-09-13, not yet physically assembled — the on-hand LM358 is bipolar-input (wrong device class for a high-impedance electrometer/charge-amp front end). See `lab/docs/parts_reference.md#tl082-jfet-input-dual-op-amp`. |
