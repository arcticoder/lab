...
| 3296 trimming potentiometer, 10 kΩ            | 9 in inventory, 1 currently on the bench | Received 2026-09-01; single-turn cermet trimmer (listing's "multi-turn" claim not yet verified against the physical part). Used as Rb (0-10kΩ, wired as a glitch-safe 2-terminal rheostat) in the `lab/oscillators/ne555_astable/` tier1 `OSC` design — bench-tested 2026-09-13, then reassembled 2026-09-19 to feed `lab/signal_conditioning/phase_detector/`'s bench test; still wired as of 2026-09-19, pending disassembly (see `lab/docs/TODO-arcticoder.md`'s "Ready to build now" item 1). See `lab/docs/parts_reference.md#3296-trimming-potentiometer` |
...
| SN74HC86N quad 2-input XOR gate, DIP-14 | 0 in inventory, 1 currently on the bench | Received 2026-09-12 (ordered 2026-09-03). The only unit on hand is bench-tested PASS 2026-09-19 in `lab/signal_conditioning/phase_detector/` (tier4 `PHASED`, feeds tier6 `LOCKIN`) — only gate 1 of 4 on the chip is wired. Still wired as of 2026-09-19, pending disassembly (see `lab/docs/TODO-arcticoder.md`'s "Ready to build now" item 1). See `lab/docs/parts_reference.md#sn74hc86n-quad-2-input-xor-gate`. |
