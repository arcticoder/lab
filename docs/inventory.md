...
| Piezo element, 12mm disc | 19 (usable); 1 destroyed | Received 2026-09-12 (ordered 2026-09-03). 1 of 20 destroyed 2026-09-16 attempting to solder leads onto it without flux for `lab/signal_conditioning/charge_amplifier/` (tier5 `CHGAMP`). That build attempt was paused as a result — the rest of its parts (a TL082, resistors, a capacitor) also came back to inventory rather than staying mid-assembly. 19 discs remain, untested, for a retry once flux is sourced (see `lab/docs/TODO-arcticoder.md`). See `lab/docs/parts_reference.md#piezo-element-12mm-disc`. |
| SN74HC86N quad 2-input XOR gate, DIP-14 | 1 | Received 2026-09-12 (ordered 2026-09-03); untested. The only unit on hand is used in `lab/signal_conditioning/phase_detector/` (tier4 `PHASED`, feeds tier6 `LOCKIN`), designed/simulated 2026-09-13, not yet physically assembled — only gate 1 of 4 on the chip is wired. See `lab/docs/parts_reference.md#sn74hc86n-quad-2-input-xor-gate`. |
